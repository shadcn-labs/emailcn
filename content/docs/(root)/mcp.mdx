...
Install items with **`npx shadcn@latest add @emailcn/<name>`** or the **`https://emailcn.dev/r/<name>.json`** URL on each docs page, then import from **`@/components/emails/...`** as usual.
