...
{
  "registries": {
    "@emailcn": "https://emailcn.vercel.app/r/{name}.json"
  }
}
```
...
```bash
npx shadcn@latest add https://emailcn.vercel.app/r/react-email/button.json
```

The complete registry index is available at `https://emailcn.vercel.app/r/registry.json`.
