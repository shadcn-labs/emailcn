...
type ProductDetail_ProductDetailThreeImagesVariant = Exclude<
  ProductDetailWithDetailsVariant,
  "rating-bottom"
>;

interface ProductDetail_ProductDetailThreeImagesProps extends Omit<
  ProductDetailContentOverrides,
  "imageUrls"
> {
  theme?: EmailTheme;
  ...
  imageUrl3?: string;
  features?: string[];
  variant?: ProductDetail_ProductDetailThreeImagesVariant;
}

const ProductDetail_ProductDetailThreeImagesSection = ({
  features: _features,
  imageUrl1,
  imageUrl2,
  imageUrl3,
  variant = "default",
  ...props
}: Omit<ProductDetail_ProductDetailThreeImagesProps, "theme">) => (
...
const ProductDetail_ProductDetailThreeImages = ({
  theme = defaultTheme,
  ...props
}: ProductDetail_ProductDetailThreeImagesProps) => (
  <Html>
    <EmailHead>
      <DefaultFonts />
    </EmailHead>
    ...
    <EmailTailwind theme={theme}>
      <Body className="m-0">
        <ProductDetail_ProductDetailThreeImagesSection {...props} />
      </Body>
    </EmailTailwind>
  </Html>
);

ProductDetail_ProductDetailThreeImages.PreviewProps = {
  theme: defaultTheme,
  variant: "default",
} satisfies ProductDetail_ProductDetailThreeImagesProps;

const __ProductDetail = ProductDetail_ProductDetailThreeImages;
