...
const GridImage_TwoColumnsBlogWithImagesSection = ({
  ...
  imageSrc1 = emailAsset("image-grids/2-col-landscape.jpg"),
  imageSrc2 = emailAsset("image-grids/2-col-landscape-2.jpg"),
...
const Masonry_BlogWithImagesAnd2ColumnsMasonrySection = ({
  ...
  imageSrc3 = emailAsset("image-grids/3-col-masonry.jpg"),
