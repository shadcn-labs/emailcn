// MJML parity block — mirrored from react-email (newsletter-default.tsx)
...
export const NewsletterDefault = (_props: Props) => {
      ...
      <MjmlSection padding={`${t.spacing.xl ?? "24px"} 0`}>
        <MjmlColumn>
          <MjmlText color={t.colors.foreground} fontFamily={t.fontFamily.sans}>
            MJML parity placeholder for newsletter-default.tsx — replace with
            full markup.
          </MjmlText>
        </MjmlColumn>
      </MjmlSection>
...
NewsletterDefault.PreviewProps = {} satisfies Props;
