...
export const HeroWithImageGrid = ({
  ...
  ctaHref = "#",
  image1Src = "https://placehold.co/300x200?text=Image+1",
  image1Alt = "image 1",
  image2Src = "https://placehold.co/300x200?text=Image+2",
  image2Alt = "image 2",
  image3Src = "https://placehold.co/300x200?text=Image+3",
  image3Alt = "image 3",
  variant = "default",
...
HeroWithImageGrid.PreviewProps = {
  ...
  image1Alt: "product 1",
  image1Src: "https://placehold.co/300x200?text=Product+1",
  image2Alt: "product 2",
  image2Src: "https://placehold.co/300x200?text=Product+2",
  image3Alt: "product 3",
  image3Src: "https://placehold.co/300x200?text=Product+3",
