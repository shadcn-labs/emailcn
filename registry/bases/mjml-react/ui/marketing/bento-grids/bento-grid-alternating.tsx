...
export const BentoGridAlternating = ({
  theme = defaultTheme,
  rows = [
    {
      align: "left",
      ...
      imageAlt: "img1",
      imageUrl: "https://placehold.co/400x300?text=Left",
      title: "Left Aligned",
    },
    {
      align: "right",
      ...
      imageAlt: "img2",
      imageUrl: "https://placehold.co/400x300?text=Right",
      title: "Right Aligned",
    },
  ],
  variant = "default",
...
BentoGridAlternating.PreviewProps = {
  rows: [
    {
      align: "left",
      description: "Text on the right side of the image.",
      imageAlt: "feature 1",
      imageUrl: "https://placehold.co/400x300?text=Feature+1",
      title: "Feature One",
    },
    {
      align: "right",
      ...
      imageAlt: "feature 2",
      imageUrl: "https://placehold.co/400x300?text=Feature+2",
      title: "Feature Two",
    },
  ],
  theme: defaultTheme,
