...
export const BentoGridWith3ColumnsAndEvenSplitTextStats = ({
  ...
  imageSrc1 = "https://placehold.co/400x300?text=Project+Alpha",
  imageAlt1 = "",
  caption1 = "Project Alpha",
  imageSrc2 = "https://placehold.co/400x300?text=Project+Beta",
  imageAlt2 = "",
  caption2 = "Project Beta",
  imageSrc3 = "https://placehold.co/400x300?text=Project+Gamma",
  imageAlt3 = "",
