...
export const FeatureWithMultipleProductImagesSection = ({
  ...
  imageSrc1 = "https://static.photos/technology/200x200/2",
  imageAlt1 = "",
  imageSrc2 = "https://static.photos/technology/200x200/3",
  imageAlt2 = "",
  imageSrc3 = "https://static.photos/technology/200x200/4",
  imageAlt3 = "",
  variant = "default",
...
export const FeatureWithMultipleProductImages = ({
  ...
  heading = "Product Collection",
  body = "Browse our latest collection.",
  imageSrc1 = "https://static.photos/technology/200x200/5",
  imageAlt1 = "",
  imageSrc2 = "https://static.photos/technology/200x200/6",
  imageAlt2 = "",
  imageSrc3 = "https://static.photos/technology/200x200/7",
  imageAlt3 = "",
  variant = "default",
...
FeatureWithMultipleProductImages.PreviewProps = {
  ...
  imageAlt2: "Product 2",
  imageAlt3: "Product 3",
  imageSrc1: "https://static.photos/technology/200x200/8",
  imageSrc2: "https://static.photos/technology/200x200/9",
  imageSrc3: "https://static.photos/technology/200x200/10",
  theme: defaultTheme,
  variant: "default",
