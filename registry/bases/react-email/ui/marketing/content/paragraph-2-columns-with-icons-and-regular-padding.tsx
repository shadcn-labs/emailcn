...
export type Paragraph2ColumnsWithIconsAndRegularPaddingVariant =
  | "default"
  | "slanted-left"
  | "slanted-right";

export interface Paragraph2ColumnsWithIconsAndRegularPaddingProps {
  ...
  iconAlt2?: string;
  column2?: string;
  variant?: Paragraph2ColumnsWithIconsAndRegularPaddingVariant;
}
...
export const Paragraph2ColumnsWithIconsAndRegularPaddingSection = ({
  ...
  variant = "default",
}: Omit<Paragraph2ColumnsWithIconsAndRegularPaddingProps, "theme">) => {
...
export const Paragraph2ColumnsWithIconsAndRegularPadding = ({
  ...
  column2 = "Text for the second column with an icon above.",
  variant = "default",
}: Paragraph2ColumnsWithIconsAndRegularPaddingProps) => (
  <Html>
    <Head>
      <DefaultFonts />
    </Head>
    ...
    <Tailwind config={theme}>
      <Body className="m-0 bg-background font-sans">
        <Paragraph2ColumnsWithIconsAndRegularPaddingSection
          column1={column1}
          column2={column2}
          iconAlt1={iconAlt1}
          iconAlt2={iconAlt2}
