...
export type OutlinedSquareTilesSocialLogosVariant =
  | "default"
  | "slanted-left"
  | "slanted-right";

export interface OutlinedSquareTilesSocialLogosProps {
  ...
  socialSrc4?: string;
  socialAlt4?: string;
  variant?: OutlinedSquareTilesSocialLogosVariant;
}
      ...
      >
        <Row>
          <Column className="px-3 text-center align-middle">
            <Section className="inline-block rounded-lg border border-border p-3">
              <Img
                src={socialSrc1}
                alt={socialAlt1}
                width="24"
  ...
  <Html>
    ...
    <Tailwind config={theme}>
      <Body className="m-0 bg-background font-sans">
        <OutlinedSquareTilesSocialLogosSection
