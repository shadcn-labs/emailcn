...
export const TwoColumnsBlogWithImagesAndTextSection = ({
  ...
  imageSrc1 = "https://static.photos/travel/200x200/2",
  imageAlt1 = "",
  title1 = "Post One",
  excerpt1 = "Description for post one.",
  imageSrc2 = "https://static.photos/travel/200x200/3",
  imageAlt2 = "",
  title2 = "Post Two",
...
export const TwoColumnsBlogWithImagesAndText = ({
  theme = defaultTheme,
  heading = "Latest Posts",
  imageSrc1 = "https://static.photos/travel/200x200/4",
  imageAlt1 = "",
  title1 = "Post One",
  excerpt1 = "Description for post one.",
  imageSrc2 = "https://static.photos/travel/200x200/5",
  imageAlt2 = "",
  title2 = "Post Two",
  excerpt2 = "Description for post two.",
  variant = "default",
...
TwoColumnsBlogWithImagesAndText.PreviewProps = {
  ...
  imageAlt1: "Post 1",
  imageAlt2: "Post 2",
  imageSrc1: "https://static.photos/travel/200x200/6",
  imageSrc2: "https://static.photos/travel/200x200/7",
  theme: defaultTheme,
