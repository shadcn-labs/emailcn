...
export const TwoColumnTeamCardsWithDetailsSection = ({
  heading = "Our Team",
  avatarSrc1 = "https://static.photos/technology/200x200/2",
  avatarAlt1 = "",
  name1 = "Jane Doe",
  role1 = "CEO",
  bio1 = "Jane has over 15 years of experience.",
  avatarSrc2 = "https://static.photos/technology/200x200/3",
  avatarAlt2 = "",
  name2 = "John Smith",
  role2 = "CTO",
...
export const TwoColumnTeamCardsWithDetails = ({
  theme = defaultTheme,
  heading = "Our Team",
  avatarSrc1 = "https://static.photos/technology/200x200/4",
  avatarAlt1 = "",
  name1 = "Jane Doe",
  role1 = "CEO",
  bio1 = "Jane has over 15 years of experience.",
  avatarSrc2 = "https://static.photos/technology/200x200/5",
  avatarAlt2 = "",
  name2 = "John Smith",
  role2 = "CTO",
  bio2 = "John leads our engineering team.",
...
TwoColumnTeamCardsWithDetails.PreviewProps = {
  ...
  avatarSrc1: "https://static.photos/technology/200x200/6",
  avatarSrc2: "https://static.photos/technology/200x200/7",
