...
export type BoxedLogoCloudVariant =
  | "default"
  | "slanted-left"
  | "slanted-right";

export interface BoxedLogoCloudProps {
  ...
  logoSrc4?: string;
  logoAlt4?: string;
  variant?: BoxedLogoCloudVariant;
}

export const BoxedLogoCloudSection = ({
  heading = "Trusted by",
  ...
  logoAlt4 = "Logo 4",
  variant = "default",
}: Omit<BoxedLogoCloudProps, "theme">) => {
      ...
      >
        ...
        <Row>
          <Column className="w-1/4 px-2 align-middle">
            <Section className="rounded-lg bg-background-muted px-6 py-4">
              <Img
                src={logoSrc1}
                alt={logoAlt1}
                width="120"
