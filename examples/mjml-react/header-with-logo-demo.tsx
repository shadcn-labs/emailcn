import { HeaderWithLogo } from "@/registry/bases/mjml-react/ui/marketing/headers/header-with-logo";
...
type HeaderWithLogoExampleVariant = keyof typeof variants;

export default function HeaderWithLogoDemo({
  variant,
}: {
  variant?: HeaderWithLogoExampleVariant;
}) {
  const selected = variants[variant ?? "minimal-center"];
  return (
    <HeaderWithLogo
