...
export default function FooterWithBackgroundImageVariantTopImage3ColumnMenuLeftLogoExampleDemo() {
  const logoPosition = ("top-image-3-column-menu-left-logo" as string).endsWith(
    "-right-logo"
  )
    ? "right"
    : "left";
  const componentVariant = (
    "top-image-3-column-menu-left-logo" as string
...
FooterWithBackgroundImageVariantTopImage3ColumnMenuLeftLogoExampleDemo.PreviewHeight = 900;
