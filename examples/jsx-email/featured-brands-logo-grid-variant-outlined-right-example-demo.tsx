import { FeaturedBrandsLogoGrid } from "@/registry/bases/jsx-email/ui/marketing/logos/featured-brands-logo-grid";
...
export default function FeaturedBrandsLogoGridVariantOutlinedRightExampleDemo() {
  const selected = variants["outlined-right"];
  return (
