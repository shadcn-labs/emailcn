...
export default function FooterWithBackgroundImageVariantTopImageCenteredExampleDemo() {
  const logoPosition = ("top-image-centered" as string).endsWith("-right-logo")
    ? "right"
    : "left";
  const componentVariant = ("top-image-centered" as string).replace(
    /-(left|right)-logo$/,
    ""
...
FooterWithBackgroundImageVariantTopImageCenteredExampleDemo.PreviewHeight = 900;
